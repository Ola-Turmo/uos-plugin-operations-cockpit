...
import type { Incident, IncidentStatus, IncidentRole, IncidentRoleAssignment, IncidentTimelineEntry } from '../types/incident';
...
export class IncidentCommander {
  ...
  listIncidents(filter?: { status?: IncidentStatus }): Incident[] {
